...
public class FirstController {
    /*
    * 컨트롤러 핸들러 매서드의 반환 값을 void로 설정하면 요청주소가 view의 이름이 된다.
    * => /first/regist 요청이 들어오면 /first/regist 뷰를 응답한다.
    ...
    /*
    * WebRquest로 요청 파라미터 받기
    * 파라미터 선언부에 WebRequest 타입을 선언하면 해당 메소드 호출 시 인자로 값을 전달해준다.
    * HttpServletRequest, HttpServletResponse / sevletRequest,sevletResponse 가능하다.
    *
     */
     ...
     * form의 name 속성값과 매개변수의 이름이 다른 경우 @RequesParam("이름") 설정하면 된다.
     *
