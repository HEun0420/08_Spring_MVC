...
* 이때 와일드 카드를 이용해서 좀 더 포괄적인 URL 패턴을 설정할 수 있다.
 */
...
public class ClassMappingTestController {
    ...
    public String modifyAndDelete(Model model){
        ...
        model.addAttribute("message", "Post방식의 주문 정보 수정과 주문정보 삭제 공통 처리용 핸들러 메소드 호출함");
    ...
    * 만약, 동일하지 않으면 @PathVariable("이름")을 설정해주어야한다.
    ...
    public String selectOrderDetail(Model model, @PathVariable int orderNo){
        ...
        model.addAttribute("message", orderNo +" 번 주문 상세 내용 조회용 핸들과 메소드 호출함");
